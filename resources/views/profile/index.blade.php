        ...
        <div class="col-md-12" id="tc_container_wrap">
           <div class="card" id="tc_paneldefault">
              <div class="card-body" id="tc_panelbody"  style="background: #f9f9f9;"> 
                 <div class="card">
                    <div class="card-header" style="background-color: #2F4799;">
                      <div class="menu_a" style="float: left;">
                      <a href="#"><i class="fa fa-user-o"></i> {{$user->name}} : Daftar Pertanyaan</a> 
                      </div> 
                 </div> 
              </div> 
          <div class="row">
           <div class="col-md-12">
            ...
            <tbody>   
               ...
               <tr> 
                <td>{{$forum->title}}<i style="font-size: 10px; color: #999;"> {{$forum->created_at->diffForHumans()}}</i>
                 </td>
