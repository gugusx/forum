...
<div class="container">
    <div class="row">
        <div class="col-md-12" id="tc_container_wrap">
            ...
            <div class="card">
  <div class="card-header" style=" background-color: #2F4799; color: #fff; border-top-right-radius: 0px; border-top-left-radius: 0px;"><i class="fa fa-clock-o" style="color: #eee"></i> <small style="color: #eee">{{$comment->created_at->diffForHumans()}}</small></div>
  <div class="card-body" style="background: #f9f9f9; "> 
    <div class="row">
      <div class="col-md-3" id="img_comment">
        
        <div class="comment_user">
        <b><i class="fa fa fa-user-circle-o"></i> {{$comment->user->name}}</b>
        </div>
      </div>
      <div class="col-md-8">
      {{$comment->content}}
  ...
  <hr>
            ...
            <div class="add_comment">
              <div class="open_comment">
                  <div class="h1"><h4>Tambahkan Komentar</h4></div>
              </div>
              @if(Auth::guest())
              <div class="comment-show" style="padding: 60px">
               <a href="{{route('login')}}" style="color: #2ab27b"> <i class="fa fa-sign-in"></i> Login </a> terlebih dahulu.
              </div>
              @else
