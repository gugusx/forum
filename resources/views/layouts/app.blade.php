...
<head>
    ...
    <title>Forum-OC | @yield('title')</title>
...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light navbar-laravel" style=" background-color: #2F4799;">
            <div class="container" id="nav_ul">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <li><a class="nav-link" href="{{ route('forum.index') }}">{{ __('Daftar Diskusi') }}</a></li>
        ...
        <main class="py-4"> 
            <!-- Pesan error kolom tidak boleh kosong -->
            <div class="container">
